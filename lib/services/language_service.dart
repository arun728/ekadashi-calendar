...
class LanguageService extends ChangeNotifier {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'notify_parana': 'When Parana Time Starts',
      'status_active': 'Active',
      'status_disabled': 'Disabled',
      'test_notification': 'Test Notification',
      'test_notification_desc': 'Send a test notification',
      'test_notif_title': 'Hari Om!',
      'test_notif_body': 'Your notifications are working perfectly!',
    ...
    'ta': {
      ...
      'notify_parana': 'பாரணை நேரம் தொடங்கும்போது',
      'status_active': 'செயலில்',
      'status_disabled': 'முடக்கம்',
      'test_notification': 'சோதனை அறிவிப்பு',
      'test_notification_desc': 'சோதனை அனுப்பு',
      'test_notif_title': 'ஹரி ஓம்!',
      'test_notif_body': 'உங்கள் அறிவிப்புகள் சரியாக வேலை செய்கின்றன!',
