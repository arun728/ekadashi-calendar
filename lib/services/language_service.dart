...
class LanguageService extends ChangeNotifier {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    ...
    'ta': {
      ...
      // Info dialog translations
      'info_close': 'சரி',
      'alarms_info_title': 'அலாரம் & நினைவூட்டல்',
      'alarms_info_why': 'ஏன் தேவை',
      'alarms_info_why_desc': 'ஏகாதசி விரத நேரங்கள் குறிப்பிட்ட சூரிய உதய நேரத்தை அடிப்படையாகக் கொண்டவை. சரியான நேரத்தில் நினைவூட்டல்கள் பெற இது உதவுகிறது.',
      'alarms_info_steps': 'இயக்குவது எப்படி',
      'alarms_info_step1': '1. அமைப்புகளுக்கு "திற" தட்டவும்',
      'alarms_info_step2': '2. "அலாரம் அமைக்க அனுமதி" ON செய்யவும்',
      'alarms_info_note': 'குறிப்பு: சில சாதனங்களில், இது ஏற்கனவே இயக்கப்பட்டிருக்கும்.',
      'battery_info_title': 'பேட்டரி உகப்பாக்கம்',
      'battery_info_why': 'ஏன் தேவை',
      'battery_info_why_desc': 'பேட்டரி உகப்பாக்கம் இயக்கப்பட்டிருந்தால், உங்கள் ஏகாதசி நினைவூட்டல்கள் தாமதமாகலாம் அல்லது தவறவிடப்படலாம்.',
      'battery_info_steps': 'பின்னணி பயன்பாட்டை அனுமதிப்பது எப்படி',
      'battery_info_step1': '1. ஆப் தகவலுக்கு "திற" தட்டவும்',
      'battery_info_step2': '2. "பேட்டரி" தட்டவும்',
      'battery_info_step3': '3. "பின்னணி பயன்பாட்டை அனுமதி" இயக்கவும் அல்லது "வரம்பற்றது" தேர்வு செய்யவும்',
      'battery_info_note': 'இது உங்கள் தொலைபேசி செயலற்ற நிலையிலும் அறிவிப்புகள் சரியான நேரத்தில் வருவதை உறுதி செய்கிறது.',
      // Share translations
    ...
    'hi': {
      ...
      // Info dialog translations
      'info_close': 'समझ गया',
      'alarms_info_title': 'अलार्म और रिमाइंडर',
      'alarms_info_why': 'यह क्यों जरूरी है',
      'alarms_info_why_desc': 'एकादशी व्रत का समय विशेष सूर्योदय समय पर आधारित होता है। सटीक अलार्म सुनिश्चित करता है कि आपको सही समय पर रिमाइंडर मिले।',
      'alarms_info_steps': 'कैसे सक्षम करें',
      'alarms_info_step1': '1. सेटिंग्स पर जाने के लिए "खोलें" टैप करें',
      'alarms_info_step2': '2. "अलार्म सेट करने की अनुमति" ON करें',
      'alarms_info_note': 'नोट: कुछ डिवाइस पर, यह पहले से सक्षम हो सकता है।',
      'battery_info_title': 'बैटरी ऑप्टिमाइज़ेशन',
      'battery_info_why': 'यह क्यों जरूरी है',
      'battery_info_why_desc': 'अगर बैटरी ऑप्टिमाइज़ेशन सक्षम है, तो Android आपके एकादशी रिमाइंडर में देरी कर सकता है या छोड़ सकता है।',
      'battery_info_steps': 'बैकग्राउंड उपयोग कैसे अनुमति दें',
      'battery_info_step1': '1. ऐप जानकारी के लिए "खोलें" टैप करें',
      'battery_info_step2': '2. "बैटरी" पर टैप करें',
      'battery_info_step3': '3. "बैकग्राउंड उपयोग अनुमति दें" सक्षम करें या "अप्रतिबंधित" चुनें',
      'battery_info_note': 'यह सुनिश्चित करता है कि आपका फोन निष्क्रिय होने पर भी नोटिफिकेशन समय पर आएं।',
      // Share translations
